...
upgrade_bin() {
    rm "${BIN_PATH_INSTALLED}" || (echo "cs-cloudfare-bouncer is not installed, exiting." && exit 1)
...
upgrade_bin
systemctl start cs-cloudfare-bouncer
echo "cs-cloudfare-bouncer upgraded successfully."