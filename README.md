...
cache_path: /var/lib/crowdsec/cache/cloudflare-cache.json
```
...
# Troubleshooting
 ...
 - The cache is at `/var/lib/crowdsec/cache/cloudflare-cache.json`. It can be inspected to see the state of bouncer and cloudflare components locally.
